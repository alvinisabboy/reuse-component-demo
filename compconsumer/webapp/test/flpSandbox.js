		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demosureshcompconsumer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demosureshcompconsumer-display": {
								"semanticObject": "demosureshcompconsumer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.suresh.compconsumer",
									"url": sap.ui.require.toUrl("demo/suresh/compconsumer")
								}
							}
						}
					}
